# Generated by Django 3.1 on 2021-06-10 17:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('produit', models.ManyToManyField(through='ventes.ProduitVente', to='produits.Produits')),
            ],
        ),
        migrations.AddField(
            model_name='produitvente',
            name='vente',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='ventes.ventes'),
        ),
    ]
