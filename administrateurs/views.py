...
def list_admin(request):
    ...
    if 'query' in request.GET:
        ...
        lst_admin = Administrateurs.objects.filter(models.Q(user__first_name__icontains=search, organisation_id=id_org) | models.Q(user__last_name__icontains=search,organisation_id=id_org) | models.Q(telephone__icontains=search, organisation_id=id_org) | models.Q(user__email__icontains=search,organisation_id=id_org)).select_related()
    else:
